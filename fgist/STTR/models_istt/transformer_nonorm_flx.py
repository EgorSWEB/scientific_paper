...
#         print(style_src.shape, mask.shape, pos_embed.shape)
        ...
        # print("\033[94mstyle_src shape:",style_src.shape, "\033[0m")
        # print("\033[93msrc shape:",src.shape, "\033[0m")
        # exit()
#         print("hs:",hs.shape) #torch.Size([layer_num, h*w, B, C])  
        if len(src.shape)==4:
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, memory,
        ...
        intermediate = []
        # print(tgt_key_padding_mask, tgt_mask, memory_mask, memory_key_padding_mask)
...
#                                    key_padding_mask=memory_key_padding_mask)[0]
        # print(self.with_pos_embed(tgt2, query_pos).shape)
        # print(self.with_pos_embed(memory, pos).shape)
        # print(memory_key_padding_mask.shape)
        # print(memory_key_padding_mask.sum())
